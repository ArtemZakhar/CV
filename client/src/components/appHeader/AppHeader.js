      ...
      <div className="link__track">
        <div className="item">
          <a href="https://www.facebook.com/artem.zakharchuk.7/">
            <img src={fb} alt="icon_FB" className="icon" />
          </a>
        </div>
        <div className="item">
          <a href="https://t.me/Artem_Zakharchuk">
            <img src={telegram} alt="icon_telegram" className="icon" />
          </a>
        </div>
        <div className="item">
          <a href="https://www.linkedin.com/in/artem-zakharchuk-818ba3131/">
            <img src={linkedin} alt="icon_linkedin" className="icon" />
          </a>
        </div>
      </div>
      <div className="language__track">
        <div className="item">
          <button onClick={() => handleLanguege('en')} href="eng">
            <img src={eng} alt="eng_language" className="icon" />
          </button>
        </div>
        <div className="item">
          <button onClick={() => handleLanguege('ua')} href="\">
            <img src={ua} alt="ua_language" className="icon" />
          </button>
        </div>
      </div>
    </header>
